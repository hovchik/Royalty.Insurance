...
{
    public class CreateMessageCommandHandler :  IRequestHandler<CreateMessageCommand, FileMessageResponse>
    {
        ...
        public CreateMessageCommandHandler(IApplicationDbContext context, IRequestHandler<GetMessageByIdQuery, FileMessageResponse> handler, IMessageMapperService mapper)
        {
            _context = context;
            _handler = handler;
            _mapper = mapper;
        ...
        public async Task<FileMessageResponse> Handle(CreateMessageCommand request, CancellationToken cancellationToken)
        {
