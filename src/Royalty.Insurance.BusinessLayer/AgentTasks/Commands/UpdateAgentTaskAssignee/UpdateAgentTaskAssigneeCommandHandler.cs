...
{
    public class UpdateAgentTaskAssigneeCommandHandler : IRequestHandler<UpdateAgentTaskAssigneeCommand, AgentTaskResponse>
    {
        private readonly IApplicationDbContext _context;
        private readonly ICurrentUserService _currentUserService;
        private readonly IRequestHandler<GetAgentTaskByIdQuery, AgentTaskResponse> _requestHandler;

        public UpdateAgentTaskAssigneeCommandHandler(IApplicationDbContext context, ICurrentUserService currentUserService, IRequestHandler<GetAgentTaskByIdQuery, AgentTaskResponse> requestHandler)
        {
            _context = context;
        ...
        public async Task<AgentTaskResponse> Handle(UpdateAgentTaskAssigneeCommand request, CancellationToken cancellationToken)
        {
